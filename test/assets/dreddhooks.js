...
hooks.before('/auth/user > GET > 403 > text/plain; charset=utf-8', function(transaction, done) {
...
hooks.before('/auth/topic > GET > 403 > text/plain; charset=utf-8', function(transaction, done) {
  transaction.skip = false
